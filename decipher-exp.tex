...
\label{sample_procedure}
 ...
 \begin{figure}[!ht]
  \centering
  \includegraphics[width=3.0in,height=4.0in]{iterative_sampling}
...
\subsection{Results}
In experiments, we gradually increase the size of ciphertext and compare decipherment accuracy of baseline with our new approach. We evaluate top 5 accuracy for top 5k and 10k most frequent word types for each language pair, and present them in Table \ref{}; 
